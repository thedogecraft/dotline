...
import { SplitPanel } from "@/components/panel"
...
function Editor(): React.JSX.Element {
  ...
  const viewport = (
    <div className="flex flex-col h-full">
      <div className="flex-1 flex items-center justify-center p-6">
        <div
          className={`rounded-lg border-2 relative flex items-center justify-center ${previewDark ? "bg-neutral-900 border-neutral-700" : "bg-white border-neutral-200"}`}
      ...
      <div className="border-t border-border px-4 py-3">
        <div className="flex items-center gap-2">
          <Input
            placeholder={editingExisting ? "Rename crosshair" : "Name your crosshair"}
            value={saveName}
            onChange={(e) => setSaveName(e.target.value)}
            className="flex-1"
          />
          <Button onClick={saveOverwriteOrNew} variant="outline" size="sm">
            {editingExisting ? "Update" : "Save"}
          </Button>
        </div>
        {editingExisting && (
          <p className="text-xs text-muted-foreground mt-1.5">
            Editing: <strong>{editingItemName}</strong>
      ...
      {config.style === "image" && (
        <Section title="Image Settings">
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-1.5">
              Image URLs recommended for better performance.
            </p>
          </div>
          ...
          <>
            ...
            <div className="gap-2 flex flex-col">
              <div className="flex justify-between">
                ...
                <span className="text-sm text-muted-foreground">{config.outlineOpacity ?? 1}</span>
              </div>
              <Slider
              ...
              <Switch
                ...
                onCheckedChange={(checked) => {
                  ...
                  if (checked) {
                    ...
                    if (next.centerDotOutlineThickness == null) next.centerDotOutlineThickness = 1
      ...
      <Section title="Positioning">
        <div className="grid grid-cols-2 gap-3">
          <div className="space-y-1.5">
            <Label htmlFor="editor-offsetX" className="text-xs">
              Offset X (px)
            </Label>
            <Input
              id="editor-offsetX"
          ...
          <div className="space-y-1.5">
            <Label htmlFor="editor-offsetY" className="text-xs">
              Offset Y (px)
            </Label>
            <Input
              id="editor-offsetY"
  ...
  return (
    <div className="flex flex-col h-full">
      <header className="flex items-center justify-between  py-3 border-b pt-0 border-border shrink-0">
      ...
      <div className="flex-1 min-h-0">
        <SplitPanel left={viewport} right={properties} defaultSplit={45} />
      </div>
